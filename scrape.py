...
def top_scorers():
    ...
    page = requests.get(url)
    soup = BeautifulSoup(page.text,  "html.parser")
    table= soup.find("table", attrs={"aria-label": 'Top Scorers'})
...
def player_table():
    url = [f'https://www.worldfootball.net/players_list/eng-premier-league-2024-2025/nach-name/{i:d}' for i in (range(1, 13))]
